      ...
      <el-form :inline="true" :model="bid_query" style="width: 100%">
        <div>
          <el-form-item style="width: 10%">
            ...
            <el-input v-model="bid_query.id" placeholder="竞标信息id "/>
          </el-form-item>
          <el-form-item style="width: 10%">
            <span class="label_font">竞标企业id</span>
            <el-input v-model="bid_query.e_id" placeholder="竞标企业id"/>
          </el-form-item>
          <el-form-item style="width: 10%">
            <span class="label_font">竞标项目id</span>
            <el-input v-model="bid_query.t_id" placeholder="竞标项目id"/>
          </el-form-item>
          <!--          <el-form-item style="width: 10%">-->
...
<!--            <el-input v-model="bid_query.src" placeholder="竞标书地址"/>-->
<!--          </el-form-item>-->
          <el-form-item style="width: 10%">
            <span class="label_font">竞标企业名称</span>
            <el-input v-model="bid_query.e_name" placeholder="竞标企业名称"/>
          </el-form-item>
          <el-form-item style="width: 10%">
            <span class="label_font"> 招标项目标题</span>
            <el-input v-model="bid_query.t_title" placeholder=" 招标项目标题"/>
          </el-form-item>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-link type="primary" :href="scope.row.src">竞标书</el-link>
          </template>
        </el-table-column>
        <el-table-column
          prop="e_name"
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.t_e_id===0" type="primary" size="mini" @click="deleteBid(scope.row.id)">删除
            </el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
  import {deleteBid, getBidInfo} from "../../api";
